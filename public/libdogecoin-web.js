...
var loadWASM = (() => {
    ...
    return function (loadWASM) {
        ...
        if (ENVIRONMENT_IS_SHELL) {
            ...
            if (typeof print != "undefined") {
                ...
                console.warn = console.error =
                    /** @type{!function(this:Console, ...*): undefined} */ (typeof printErr != "undefined" ? printErr : print);
            }
        }
        ...
        function UTF8ArrayToString(heapOrArray, idx, maxBytesToRead) {
            ...
            while (idx < endPtr) {
                ...
                if ((u0 & 0xf0) == 0xe0) {
                    ...
                    if ((u0 & 0xf8) != 0xf0)
                        warnOnce("Invalid UTF-8 leading byte 0x" +
                            u0.toString(16) +
            ...
            for (var i = 0; i < str.length; ++i) {
                ...
                if (u <= 0x7f) {
                    ...
                    if (outIdx + 3 >= endIdx)
                        break;
                    if (u > 0x10ffff)
                        warnOnce("Invalid Unicode code point 0x" +
                            u.toString(16) +
        ...
        assert(INITIAL_MEMORY >= STACK_SIZE, "INITIAL_MEMORY should be larger than STACK_SIZE, was " +
            INITIAL_MEMORY +
            "! (STACK_SIZE=" +
            STACK_SIZE +
            ")");
        ...
        function checkStackCookie() {
            ...
            if (cookie1 != 0x2135467 || cookie2 != 0x89bacdfe) {
                abort("Stack overflow! Stack cookie has been overwritten at 0x" +
                    max.toString(16) +
        ...
        function createExportWrapper(name, fixedasm) {
            return function () {
                ...
                assert(runtimeInitialized, "native function `" +
                    displayName +
        ...
        function abortOnCannotGrowMemory(requestedSize) {
            abort("Cannot enlarge memory arrays to size " +
                requestedSize +
